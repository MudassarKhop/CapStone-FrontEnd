		...
		<div id="container">
			<div id="sidebar">
				<div id="sidedetails1">
					<div id="img">
						<img
							src="https://i.postimg.cc/764d2NQp/IMG-20220807-134503-177.jpg"
							alt=""
						/>
					</div>
					<div id="name">
					...
					<div id="sideitem">
						<div id="sideitems1">
							...
							<div id="stock">
								...
								<p style="color: #8c9399">powered by the JSE</p>
							</div>
						</div>
						<div id="sideitems2">
							<div id="update">
								<div id="mac">
									<img
										id="macbook"
										src="https://i.postimg.cc/yYBpbLsW/Mac-PNG-Photo-1.png"
										alt=""
									/>
								</div>
								<div id="updatetext">
...
<style scoped>
	...
	tbody {
		...
		/* border-bottom: 1px solid #2b2c4b; */
	}
	table th {
		color: white;
		padding: 0.625em;
